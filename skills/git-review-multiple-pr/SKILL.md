...
**Flags**:
- `--unreviewed`: Auto-fetch all open PRs without reviews instead of explicit PR numbers
...
- If `--unreviewed` flag: auto-fetch unreviewed PRs via forge API (max 20 candidates)
