...
> **Why UTILITY?** Unlike x-research (BRAINSTORM workflow, multi-phase investigation), x-ask is self-contained and instant — no sequential flow, no PRD output, no story files. It parallels x-help and x-commit: ask a question, get an answer, done.
