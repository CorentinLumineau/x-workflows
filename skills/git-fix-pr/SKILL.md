...
> **Reference**: See `references/local-review-gate.md` for the local x-review loop,
> iteration tracking (max 3 cycles), review result gates, safety valve, and re-delegation pattern.

Run x-review locally on uncommitted changes. If issues found, loop back to x-auto (max 3 iterations).
Proceed to Phase 4 only when review passes or user overrides.
...
- **For local x-review loop, iteration tracking, and safety valve**: See `references/local-review-gate.md`
