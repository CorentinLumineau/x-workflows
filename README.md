...
| `git-commit` | All | Intelligent conventional commit messages |
...
**Investigation (DEBUG):**
```
x-troubleshoot → x-fix/x-implement → x-verify → git-commit
```

**Release:**
```
x-verify → git-commit → git-create-release
```
